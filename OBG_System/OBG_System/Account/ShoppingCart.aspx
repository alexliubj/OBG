...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
       ...
       <td style="text-align: right">
            <asp:LinkButton ID="LBUpdate" runat="server" Font-Bold="True" Font-Size="11pt" 
                onclick="LBUpdate_Click" >Update</asp:LinkButton></td>
        <td style="text-align: right">
            <asp:LinkButton ID="LBRepost" runat="server" Font-Bold="True" Font-Size="11pt" 
                onclick="LBRepost_Click"  >Continue</asp:LinkButton></td>
        <td style="text-align: right">
            <asp:ImageButton ID="IBTatil" runat="server" 
                ImageUrl="~/Pictures/checkoutButton.png" onclick="IBTatil_Click" /></td>
    </tr>
</table>
        </asp:Content>
